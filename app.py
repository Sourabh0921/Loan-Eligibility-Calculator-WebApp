...
def run():
    ...
    st.title("FINOHUB®")
    st.markdown(
        "#### Welcome to FinoHub®. It is a loan eligibility prediction system which is driven by AI. Just submit your personal details below and check your loan eligibility in one click.")
    st.warning(
